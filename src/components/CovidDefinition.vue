<template>
  <section id="about-me">
    ...
    <v-container class="text-center">
      <h2 class="display-2 font-weight-light mb-3 text--secondary">Covid-19 - 0 que é ?</h2>
      <v-responsive
        class="mx-auto mb-8"
        width="56"
      >
      ...
      <h2 class="display-1 font-weight-light mb-8 text--secondary">Covid-19 na corrente sanguínea</h2>
      ...
      >
        ...
        gastrointestinais que podem variar de condições leves e autolimitantes a distúrbios mais graves, como pneumonia
        viral com comprometimento sistêmico. ³
        Nas últimas duas décadas, o CoV foi responsável por duas grandes epidemias: a síndrome respiratória aguda grave
        (SARS) que infectou 8098 pessoas com uma taxa de letalidade de cerca de 10,5% e o oriente médio.4 Síndrome
        ...
        de 3% a 4%, de acordo com os relatórios da Organização Mundial da Saúde, 6 mas uma taxa mais alta de pacientes
        requer admissão na unidade de terapia intensiva (UTI). 7
